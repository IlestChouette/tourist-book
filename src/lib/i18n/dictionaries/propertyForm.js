const dict = {
  fr: {
    ...
    directions: "Comment arriver (facultatif)",
    directionsPlaceholder: "Ex : en venant de l'autoroute, prendre la sortie 12, tourner à gauche après la boulangerie... En transports, la gare est à 5 min à pied.",
    ...
    accentColor: "Couleur des boutons du livret",
    accentColorHint: "S'applique aux tuiles et boutons vus par vos voyageurs — laissez sur Terracotta si vous ne savez pas quoi choisir.",
  ...
  en: {
    ...
    directions: "How to get there (optional)",
    directionsPlaceholder: "E.g.: coming from the motorway, take exit 12, turn left after the bakery... By public transport, the station is a 5-minute walk.",
    ...
    accentColor: "Welcome book button color",
    accentColorHint: "Applies to the tiles and buttons your guests see — leave it on Terracotta if you're not sure.",
    photos: (n, max) => `Photos (${n}/${max})`,
    addPhoto: "+ Add",
  ...
  es: {
    ...
    directions: "Cómo llegar (opcional)",
    directionsPlaceholder: "Ej: viniendo de la autopista, toma la salida 12, gira a la izquierda después de la panadería... En transporte público, la estación está a 5 minutos caminando.",
    ...
    accentColor: "Color de los botones del livret",
    accentColorHint: "Se aplica a las tiles y botones que ven tus huéspedes — déjalo en Terracota si no sabes cuál elegir.",
